...
#TO USE WITH THIS WORDLIST https://github.com/danielmiessler/SecLists/blob/master/Passwords/Default-Credentials/default-passwords.csv

# define target url, change as needed
url = "http://127.0.0.1:8000/basic_bruteforce_php.php"
